...
-- Dumping structure for table ecom1_zf.categories
...
-- Dumping data for table ecom1_zf.categories: 5 rows
...
-- Dumping structure for table ecom1_zf.favorite_pages
...
-- Dumping data for table ecom1_zf.favorite_pages: 0 rows
/*!40000 ALTER TABLE `favorite_pages` DISABLE KEYS */;
/*!40000 ALTER TABLE `favorite_pages` ENABLE KEYS */;


-- Dumping structure for table ecom1_zf.history
...
-- Dumping data for table ecom1_zf.history: 0 rows
/*!40000 ALTER TABLE `history` DISABLE KEYS */;
/*!40000 ALTER TABLE `history` ENABLE KEYS */;


-- Dumping structure for table ecom1_zf.pages
...
-- Dumping data for table ecom1_zf.pages: 23 rows
...
-- Dumping structure for table ecom1_zf.pdfs
...
-- Dumping data for table ecom1_zf.pdfs: 4 rows
...
INSERT IGNORE INTO `pdfs` (`id`, `tmp_name`, `title`, `description`, `file_name`, `size`, `date_created`) VALUES
	(1, '44aecaeab98eded65d189cc7622bc38e3d5d8ef7', 'Javascript Cheat Sheet', 'Javascript Cheat Sheet v1', 'javascript-cheat-sheet-v1.pdf', 453, '2012-09-20 21:23:15'),
	(2, 'bfb72d1d79036539f93051f416c5324bb62d79e1', 'mod_rewrite Cheat Sheet', 'mod_rewrite Cheat Sheet v2', 'mod_rewrite-cheat-sheet-v2.pdf', 563, '2012-09-20 21:23:58'),
	(3, 'd9349ed03382cab3b05825c040f721203825d6ac', 'MySQL Cheat Sheet', 'MySQL Cheat Sheet v1', 'mysql-cheat-sheet-v1.pdf', 347, '2012-09-20 21:24:20'),
	(4, '5826a70ea5dfe8bd0dca0d547a71b8819f43b588', 'PHP Cheat Sheet', 'PHP Cheat Sheet v2', 'php-cheat-sheet-v2.pdf', 543, '2012-09-20 21:24:37');
/*!40000 ALTER TABLE `pdfs` ENABLE KEYS */;


-- Dumping structure for table ecom1_zf.users
...
-- Dumping data for table ecom1_zf.users: 3 rows
...
INSERT IGNORE INTO `users` (`id`, `type`, `username`, `email`, `pass`, `first_name`, `last_name`, `date_expires`, `date_created`, `date_modified`) VALUES
	(1, 'admin', 'admin', 'admin@example.com', 'd41e98d1eafa6d6011d3a70f1a5b92f0', 'admin', 'admin', '2012-10-05', '2012-09-05 15:15:37', '2012-09-05 18:48:48'),
	(2, 'member', 'demo', 'demo@example.com', 'd41e98d1eafa6d6011d3a70f1a5b92f0', 'demo', 'demo', '2012-10-20', '2012-09-20 21:28:42', '0000-00-00 00:00:00'),
	(3, 'member', 'demo2', 'demo2@example.com', 'd41e98d1eafa6d6011d3a70f1a5b92f0', 'demo', 'demo', '2012-10-20', '2012-09-20 21:28:57', '0000-00-00 00:00:00');
